package Lista5.SortingTester.testing.generation.linked;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.List;

import Lista5.SortingTester.testing.MarkedValue;
import Lista5.SortingTester.testing.generation.Generator;
